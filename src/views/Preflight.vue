    ...
    <main class="max-w-lg mx-auto w-auto flex-grow">
      <div class="rounded-lg bg-white shadow-lg mx-3 -mt-48 mb-10">
        <div class="px-3 pt-3 pb-1">
          ...
          <div v-if="urlError" class="text-lg py-8 text-gray-700 font-medium text-center">
            {{ urlError }}
          </div>
          <span v-else class="text-center pb-10">
            ...
            <span v-if="longURL" class="bg-gray-300 py-1 px-2 mx-4 mb-8 rounded truncate block">
              {{ longURL }}
            </span>
            <span v-else class="bg-gray-300 py-1 px-2 mx-4 mb-8 rounded truncate block">
